...
-- `kikimimi_app` gets exactly the grants it needs (USAGE + SELECT/INSERT on
...
GRANT USAGE ON SCHEMA public TO kikimimi_app;
GRANT SELECT, INSERT ON events TO kikimimi_app;
